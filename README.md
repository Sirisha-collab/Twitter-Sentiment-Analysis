...
This repository contains projects for analyzing Twitter text using NLP, ML, and Big Data concepts.

 1. LLM_Sentiment.ipynb – Sentiment analysis using large language models with visualizations.

 2. Twitter Analysis.ipynb – Basic Twitter text preprocessing and feature extraction.

 3. Twitter_Analysis_with_ML.ipynb – TF-IDF vectorization and ML model comparison (Logistic Regression, SVM, Naive Bayes).
